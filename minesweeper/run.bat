...
del /q Main.exe minesweeper.exe *.hi *.o src\*.hi src\*.o test\*.hi test\*.o 2>nul
...
del /q minesweeper.exe *.hi *.o src\*.hi src\*.o test\*.hi test\*.o 2>nul
